...
class CompaniesMap extends Component {
    ...
    render() {
        let { companies } = this.props.company;
        return (
            <div className = "map">
                <Map className = "map" center={[41.505, -0.09]} zoom={this.state.zoom}>
                    <TileLayer
                    ...
                    />
                    {
                        companies.map(company => {
                            ...
                            >
                                <Popup>
                                    <h3>Name:</h3> {company.name} <br/> <h3>Description:</h3> {company.description} <br/> <h3>Website:</h3> {company.website}
                                </Popup>
                            </Marker>);
                        })
                    }
